...
import org.apache.hadoop.fs.{FSDataInputStream, FileSystem, Seekable}
import org.apache.hadoop.io.compress._
import org.apache.hadoop.mapreduce.lib.input.FileSplit

/**
 * Reused from DBPedia distibuted extraction framework (https://github.com/dbpedia/distributed-extraction-framework)
 */
